...
const api: PiDesktopApi = {
  ...
  projects: {
    ...
    diff: (projectPath) => ipcRenderer.invoke(IpcChannels.gitDiff, projectPath)
  },
  sessions: {
    ...
    recover: (sessionPath, action) => ipcRenderer.invoke(IpcChannels.recoverSession, sessionPath, action),
